# Generated by Django 2.0.5 on 2018-05-14 08:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.OneToOneField(help_text='Cena', on_delete=django.db.models.deletion.CASCADE, to='realities.BuildingPrice')),
            ],
        ),
        migrations.CreateModel(
            name='Keyword',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(help_text='Plocha', on_delete=django.db.models.deletion.CASCADE, to='realities.Area')),
                ('documents', models.ManyToManyField(blank=True, help_text='Dokumenty a přílohy', to='realities.Attachment')),
                ('location', models.OneToOneField(blank=True, help_text='Umístění', null=True, on_delete=django.db.models.deletion.CASCADE, to='cigeo.Location')),
                ('photos', models.ManyToManyField(blank=True, help_text='Obrázky a fotky', to='realities.Photo')),
            ],
        ),
        migrations.CreateModel(
            name='RealEstateType',
        ...
        migrations.AddField(
            model_name='building',
            name='disposal',
            field=models.OneToOneField(help_text='Dispozice', on_delete=django.db.models.deletion.CASCADE, related_name='disposal_area', to='realities.BuildingDisposal'),
        ),
        migrations.AddField(
            model_name='building',
            name='floors',
            field=models.ForeignKey(help_text='Patra', on_delete=django.db.models.deletion.CASCADE, to='realities.Floor'),
        ),
        migrations.AddField(
            model_name='building',
            name='free_area',
            field=models.OneToOneField(help_text='Volná plocha', on_delete=django.db.models.deletion.CASCADE, related_name='free_area', to='realities.BuildingArea'),
        ),
        migrations.AddField(
            model_name='building',
            name='ownership',
            field=models.OneToOneField(help_text='Typ vlastnictví', on_delete=django.db.models.deletion.CASCADE, to='realities.Ownership'),
        ),
        migrations.AddField(
            model_name='building',
            name='price',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='realities.BuildingPrice'),
        ),
        migrations.AddField(
            model_name='building',
            name='total_area',
            field=models.OneToOneField(help_text='Celková plocha', on_delete=django.db.models.deletion.CASCADE, related_name='total_area', to='realities.BuildingArea'),
        ),
        migrations.AddField(
            model_name='building',
            name='used_area',
            field=models.OneToOneField(help_text='Využitá plocha', on_delete=django.db.models.deletion.CASCADE, related_name='used_area', to='realities.BuildingArea'),
        ),
        migrations.AddField(
            model_name='areaprice',
            name='rental_price',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='rental', to='realities.Price'),
        ),
        migrations.AddField(
            model_name='areaprice',
            name='selling_price',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='selling', to='realities.Price'),
        ),
        migrations.AddField(
            model_name='area',
            name='area',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='realities.AreaArea'),
        ),
        migrations.AddField(
            model_name='area',
            name='buildings',
            field=models.ManyToManyField(help_text='Budovy na pozemku', to='realities.Building'),
        ),
        migrations.AddField(
            model_name='area',
            name='ownership',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='realities.Ownership'),
        ),
        migrations.AddField(
            model_name='area',
            name='price',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='realities.AreaPrice'),
        ),
        migrations.AddField(
            model_name='area',
            name='purpose',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='realities.Purpose'),
        ),
        migrations.CreateModel(
            name='DrinkingWater',
            fields=[
        ...
        migrations.AddField(
            ...
            name='electricity',
            field=models.OneToOneField(blank=True, help_text='Elektřina', null=True, on_delete=django.db.models.deletion.SET_NULL, to='realities.Electricity'),
        ),
        migrations.AddField(
            model_name='realestate',
            name='gas',
            field=models.OneToOneField(blank=True, help_text='Plyn', null=True, on_delete=django.db.models.deletion.SET_NULL, to='realities.Gas'),
        ),
        migrations.AddField(
            model_name='realestate',
            name='telecommunications',
            field=models.OneToOneField(blank=True, help_text='Telekomunikace', null=True, on_delete=django.db.models.deletion.SET_NULL, to='realities.Telecommunications'),
        ),
        migrations.AddField(
            model_name='realestate',
            name='waste_water',
            field=models.OneToOneField(blank=True, help_text='Odpadní voda', null=True, on_delete=django.db.models.deletion.SET_NULL, to='realities.WasteWater'),
        ),
        migrations.AddField(
            model_name='realestate',
            name='drinking_water',
            field=models.OneToOneField(blank=True, help_text='Pitná voda', null=True, on_delete=django.db.models.deletion.SET_NULL, to='realities.DrinkingWater'),
        ),
        migrations.AddField(
            model_name='realestate',
            name='nonpotablewater',
            field=models.OneToOneField(blank=True, help_text='Užitková voda', null=True, on_delete=django.db.models.deletion.SET_NULL, to='realities.NonPotableWater'),
        ),
    ]
