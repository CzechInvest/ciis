...
class BrownfieldWasteWaterSevage(WasteWaterSevage):
    green_field = models.OneToOneField(
        "Brownfield",
        on_delete=models.CASCADE
    )
...
class BrownfieldWasteWaterRain(WasteWaterRain):
    green_field = models.OneToOneField(
        "Brownfield",
        on_delete=models.CASCADE
    )
...
class BrownfieldWasteWaterIndustrial(WasteWaterIndustrial):
    green_field = models.OneToOneField(
        "Brownfield",
        on_delete=models.CASCADE
    )
