# Generated by Django 2.0.5 on 2018-08-23 15:41
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('entrepreneurial_property', '0005_auto_20180823_1520'),
    ]

    operations = [
        migrations.CreateModel(
            name='IndustrialArealAttachment',
            fields=[
        ...
        migrations.CreateModel(
            name='IndustrialArealDrinkWater',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='IndustrialArealElectricity',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('distance', models.IntegerField(default=0, help_text='Dinstance to object <code>[m]</code>', verbose_name='Distnace')),
                ('note', models.TextField(blank=True, help_text='Note', verbose_name='Note')),
        ...
        migrations.CreateModel(
            name='IndustrialArealGenericNote',
            fields=[
                ...
                ('green_field', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='entrepreneurial_property.IndustrialAreal')),
            ],
            bases=('cigeo.genericnote',),
        ),
        migrations.CreateModel(
            name='IndustrialArealLocation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='IndustrialArealTechnologicalWater',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('distance', models.IntegerField(default=0, help_text='Dinstance to object <code>[m]</code>', verbose_name='Distnace')),
                ('note', models.TextField(blank=True, help_text='Note', verbose_name='Note')),
        ...
        migrations.CreateModel(
            name='IndustrialArealTelecommunication',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('distance', models.IntegerField(default=0, help_text='Dinstance to object <code>[m]</code>', verbose_name='Distnace')),
                ('note', models.TextField(blank=True, help_text='Note', verbose_name='Note')),
